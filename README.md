...
iOS and Android 7.1 (build/versionCode 38) add Weekly Challenge places with a podium and 20 places per page, Help & Feedback on GitHub or Discord, an Android in-app language picker, and on-device food-photo analysis with Apple Intelligence on iOS 27. 7.0 remains the release that added optional Plus/Pro hosted AI on iPhone, daily steps, Walk/Run logging, custom exercises, meal date/time, the Log Food widget, pinch-zoom photos, and Czech and Ukrainian.
